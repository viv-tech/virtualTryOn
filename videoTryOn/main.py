...
absPath = "c:/Users/viv91/Desktop/virtualTryOn/videoTryOn"
...
imageNumber = 0
imgButtonRight = cv2.imread("C:\\Users\\viv91\\Desktop\\virtualTryOn\\videoTryOn\\Resources\\button.png", cv2.IMREAD_UNCHANGED)
...
while True:
    ...
    if lmList:
        ...
        lm11 = lmList[12][0:2]
        lm12 = lmList[11][0:2]
        print(os.path.join(shirtFolderPath, listShirts[imageNumber]))
